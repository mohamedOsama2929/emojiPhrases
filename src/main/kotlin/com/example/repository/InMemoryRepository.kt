...
class InMemoryRepository :Repository {
    ...
    override suspend fun phrase(id: Int): EmojiPhrase? =phrase(id = id.toString())

    override suspend fun phrase(id: String): EmojiPhrase? =phrases.find { it.id.toString()==id }?:
    throw IllegalArgumentException("No phrase found for $id.")

    override suspend fun phrase()=phrases
